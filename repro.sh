...
OPTS="-XX:+UnlockDiagnosticVMOptions -XX:-UseCompressedOops -XX:-TieredCompilation -XX:+TraceReduceAllocationMerges"
...
# EXECUTE WHOLE GROUP
  make test CONF=release TEST=test/langtools/:tier1 JTREG="JAVA_OPTIONS=${OPTS};REPEAT_COUNT=500"
